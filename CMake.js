...
class WinCMake extends CMake {
    ...
    getPlatformArgs(arch) {
        return [
            ...
            "-DCMAKE_PROJECT_INCLUDE=" + path.resolve(__dirname, "msvc.cmake"),
            "-DCMAKE_PROJECT_skcms_INCLUDE_BEFORE=" + path.resolve(__dirname, "clang.cmake"),
            "-DCMAKE_PROJECT_pathkit_INCLUDE_BEFORE=" + path.resolve(__dirname, "clang.cmake"),
        ];
    }
}
