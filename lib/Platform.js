...
class AndroidPlatform extends Platform {
    ...
    toolVersion() {
        let version = super.toolVersion();
        return version + " Android NDK " + this.ndkVersion;
    }
...
class WebPlatform extends Platform {
    ...
    toolVersion() {
        let info = super.toolVersion();
        return info + " Emscripten SDK " + this.emccVersion;
    }
...
function findGCCVersion() {
    let gcc = Utils.execSafe("gcc --version");
    if (!gcc) {
        return "";
    }
    let lines = gcc.split("\n");
