...
class AndroidPlatform extends Platform {
    constructor(debug, verbose) {
        ...
        if (!this.ndkHome) {
            ...
            Utils.log("Found working NDK in: " + this.ndkHome);
        }
    }
...
function findMSVCNativeToolCommand() {
    let programDataPath = Utils.execSafe("echo %ProgramData%");
...
class WinPlatform extends Platform {
    constructor(debug, verbose) {
        ...
        let buildToolPath = Utils.execSafe("\"" + msvcTool + "\"");
