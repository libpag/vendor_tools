...
if (MSVC)
    string(REGEX MATCH ".*Microsoft Visual Studio.*VC/Tools/MSVC/" CMAKE_VS_PATH ${CMAKE_C_COMPILER})
    if (CMAKE_VS_PATH)
        string(REGEX REPLACE "/VC/Tools/MSVC/" "" CMAKE_VS_PATH ${CMAKE_VS_PATH})
        message("Using Visual Studio: ${CMAKE_VS_PATH}")
        set(ENV{CMAKE_VS_PATH} ${CMAKE_VS_PATH})
        list(APPEND ENV_LIST CMAKE_VS_PATH=${CMAKE_VS_PATH})
    endif ()
endif ()
